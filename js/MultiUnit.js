jQuery( window ).on( 'elementor:init', function() {
	...
	setRightInputRange : function(event) {
		...
		$('li.spicy-control-multiunit > input[type=number][data-name='+this.name_control+'-right]').attr({"min":min,"max":max,"step":step});
	},
	...
	setBottomInputRange : function(event)  {
		...
		$('li.spicy-control-multiunit > input[type=number][data-name='+this.name_control+'-bottom]').attr({"min":min,"max":max,"step":step});
	},
	...
	setLeftInputRange : function(event) {
		...
		$('li.spicy-control-multiunit > input[type=number][data-name='+this.name_control+'-left]').attr({"min":min,"max":max,"step":step});
	},
	// show/hide top ranges
    TopRangeToggle : function (event) {
	var cat = $(event.target).attr("data-cat");
   	  if(this.range_top==false){
       $('.spicy-units-choices-label-top[data-cat='+cat+']').not(event.target).hide();
      this.range_top = true;
	...
	RightRangeToggle : function (event) {
       ...
       $('.spicy-units-choices-label-right[data-cat='+cat+']').not(event.target).hide();
    ...
    BottomRangeToggle : function (event) {
       ...
       $('div.spicy-units-choices > label[data-cat='+cat+']').not(event.target).hide();
	...
	LeftRangeToggle : function (event) {
       ...
       $('.spicy-units-choices-label-left[data-cat='+cat+']').not(event.target).hide();
 ...
 elementor.addControlView( 'spicy-multi-unit-control', ControlMultiUnitItemView );
});
